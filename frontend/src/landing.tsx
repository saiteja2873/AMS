...
function Landing() {
    ...
    return (
        ...
        <div className="absolute top-[30%] left-[12%] box-border h-[50%] w-[80%] p-3 ">
            ...
            <div className="absolute top-[30%] text-slate-300 font-normal font-custom text-xl text-center">Efficiently manage crops, resources, and farm operations with our comprehensive 
