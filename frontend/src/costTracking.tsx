...
function ShowResults({ data }: { data: Crop[] }) {
    ...
    const calculateComparisonSummary = (data: Crop[]) => {
        ...
        return `The Crop with the Lowest Total Cost is ${lowestCostCrop.crop.crop} from ${lowestCostCrop.crop.district}, ${lowestCostCrop.crop.state} with a Total Cost of ${lowestCostCrop.totalCost}.`;
    };
