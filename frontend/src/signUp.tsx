          ...
          <div className="w-full rounded-lg shadow-lg dark:border dark:bg-gray-800 dark:border-gray-700 backdrop-blur-xl backdrop-brightness-125">
            <div className="p-6 space-y-6">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className={`w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
